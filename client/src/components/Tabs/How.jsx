            ...
            <div>
              ...
              <ul className="space-y-3 text-neutral-600">
                <li className="flex items-start">
                  <div className="mr-2 mt-1 flex h-5 w-5 items-center justify-center rounded-full bg-slate-100 text-neutral-800">
        ...
        <section className="container mx-auto px-4 md:px-6 py-20 md:py-32">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div className="bg-slate-50 p-8 rounded-xl border border-slate-200">
              <div className="flex items-center mb-6">
                <div className="bg-slate-100 p-3 rounded-lg mr-4 text-neutral-800">
          ...
          <div className="bg-slate-50 p-8 rounded-xl border border-slate-200">
            ...
            <div className="space-y-6">
              <div className="flex">
                <div className="mr-4 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-slate-200 text-neutral-800">
              ...
              <div className="p-8 md:p-12 lg:p-16 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-slate-700 text-neutral-200 hover:bg-slate-800"
                  >
                    View Documentation
                  </Button>
                </div>
  ...
  return (
    <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-all duration-200">
      <div className="flex items-center mb-4">
        <div className="bg-slate-100 h-10 w-10 rounded-full flex items-center justify-center text-neutral-800 mr-3">
          {icon}
        </div>
        <div className="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium bg-slate-100 text-neutral-800">
          Step {number}
        </div>
      </div>
      <h3 className="text-xl font-semibold mb-3">{title}</h3>
